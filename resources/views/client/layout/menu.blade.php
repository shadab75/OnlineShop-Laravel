                            ...
                            <div>
                                <ul>
                                 @foreach($category->children as $childcategory )
                                        ...
                                        <li><a href="category.html">{{$childcategory->title}}@if($childcategory->children->count()>0)<span>&rsaquo;@endif</span></a>
                ...
                <li class="menu_brands dropdown"><a href="#">برند ها</a>
                    <div class="dropdown-menu">
                        @foreach($brands as $brand)
                            <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{str_replace('public','/storage',$brand->image)}}" title="{{$brand->name}}" width="70" alt="{{$brand->name}}" /></a><a href="#">{{$brand->name}}</a></div>
