...
@section('content')
    ...
    <div id="container" style="margin-top: 0;background-color: #FFFFFF">
        <!-- Feature Box Start-->
        <div class="container">
            ...
            <div class="row">
                                    ...
                                    @if($category->Has_Children)
                                        ...
                                        <ul>
                                            @foreach($category->children as $subCategory)
                                                ...
                                                <li><a href="category.html">{{$subCategory->title}}</a> <span class="down"></span>
                                            @endforeach
                                        </ul>
                                    @endif
                                </li>
                ...
                <div id="content" class="col-sm-9">
                    ...
                    <div class="owl-carousel product_carousel">
                        ...
                        <div class="product-thumb clearfix">
                            <div class="image"><a href="product.html"><img src="/client/product/samsung_tab_1-200x200.jpg" alt="تبلت ایسر" title="تبلت ایسر" class="img-responsive" /></a></div>
                            <div class="caption">
                                <h4><a href="product.html">تبلت ایسر</a></h4>
                                <p class="price"> <span class="price-new">98000 تومان</span> <span class="price-old">240000 تومان</span> <span class="saving">-5%</span> </p>
                                <div class="rating"> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-2x"></i></span> </div>
                                        ...
                                        @foreach($subCategory->products as $product)
                                            <div class="product-thumb">
                                                <div class="image"><a href="{{route('client.products.show',$product)}}">
                                                        <img src="{{{str_replace('public','/storage',$product->image)}}}" alt="تبلت ایسر" title="تبلت ایسر" class="img-responsive" /></a></div>
                                                <div class="caption">
                                                    <h4><a href="{{route('client.products.show',$product)}}">{{$product->name}}</a></h4>
                                                    <p class="price">
                                                        <span class="price-new">{{$product->cost}} تومان</span>
                                                        @if($product->has_discount )
                                                            <span class="price-old">{{$product->get_cost_with_discount}} تومان</span> <span class="saving">-{{$product->discount_value}}%</span>
                                                        @endif
                                                    </p>
                                                </div>
                                                <div class="button-group">
                            ...
                            <div id="tab-cat5" class="tab_content">
                                <div class="owl-carousel latest_category_tabs">
                                    ...
                                    <div class="product-thumb">
                                        ...
                                        <div class="button-group">
                                            <button class="btn-primary" type="button" onClick="dsfsdf"><span>افزودن به سبد</span></button>
                                            <div class="add-to-links">
                                                <button type="button" data-toggle="tooltip" title="افزودن به علاقه مندی" onClick=""><i class="fa fa-heart"></i></button>
                                                <button type="button" data-toggle="tooltip" title="افزودن به مقایسه" onClick=""><i class="fa fa-exchange"></i></button>
                                            </div>
                                    ...
                                    <div class="caption">
                                        ...
                                        <p class="price"> <span class="price-new">{{$product->cost_with_discount}} تومان</span>
                                            @if($product->has_discount)
                                                ...
                                                <span class="price-old">{{$product->discount_value}} تومان تومان</span>
                                            @endif
                                        </p>
                                        <div class="rating"> <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-2x"></i></span> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-2x"></i></span> </div>
                                    </div>
