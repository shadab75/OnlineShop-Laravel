                        ...
                        <div class="col-sm-6">
                            ...
                            <div id="product">
                                ...
                                <div class="cart">
                                    ...
                                    <div>
                                        <button type="button" id="like-{{$product->id}}" class="wishlist" onClick="like({{$product->id}});"><i  class="fa fa-heart @if($product->is_liked) like @endif  "></i> افزودن به علاقه مندی ها</button>
                                        <br />
                        ...
                        <div id="tab-review" class="tab-pane">
                            ...
                            @endauth
                                ...
                                <div class="form-group">
                                    <input type="submit" value="ثبت دیدگاه" class="btn btn-primary btn-sm">
                                </div>
                                </form>
                                <div class="form-group required">
                                    <div class="col-sm-12">
