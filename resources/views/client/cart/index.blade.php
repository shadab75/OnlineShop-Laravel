                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            @foreach($items as $item)
                                ...
                                @endphp
                                <tr id="trindex-{{$product->id}}">
                                    <td class="text-center">
                                        <a href="product.html"><img width="100" src="{{str_replace('public','/storage',$product->image)}}" alt="تبلت ایسر" title="تبلت ایسر" class="img-thumbnail"/>
                                        </a></td>
                        ...
                        <button type="button" data-toggle="tooltip" title="بروزرسانی"  onclick="updateCart({{$product->id}})" class="btn btn-primary"><i class="fa fa-refresh"></i></button>
                        <button type="button"   title="حذف" class="btn btn-danger" onclick="removeFromCart({{$product->id}})"><i class="fa fa-times-circle"></i></button>
                        </span></div></td>
                                    <td class="text-right"> {{$product->cost_with_discount}}تومان</td>
                                    <td class="text-right"><span id="total-amount-{{$product->id}}"> {{$product->cost_with_discount * $productQty}}</span> </td>
                                </tr>
