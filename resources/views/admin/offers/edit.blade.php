                ...
                <div class="box-body">
                    <form action="{{route('offers.update',$offer)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="starts_at" id="starts_at" class="form-control" value="{{$offer->starts_at->format('Y-m-d')}}">
                        </div>

                        <div class="form-group">
                            <label for="expires_at">تاریخ پایان</label>
                            <input type="date" name="expires_at" id="expires_at" class="form-control" value="{{$offer->expires_at->format('Y-m-d')}}">
                        </div>
