...
Route::prefix('/adminpanel')->middleware([
    ...
    Route::get('/featuredCategory',[FeatureCategoryController::class,'create'])->name('featuredCategory.create');
    Route::post('/featuredCategory',[FeatureCategoryController::class,'store'])->name('featuredCategory.store');
